...
trait JobRequestContext
{
    public static $validPayload = [
        ...
        "description" =>  "Ich brauche Hilfe. Ich muss nach Charlottenburg umziehen aber habe kein Auto dafür. Können Sie mir helfen, bitte?",
    ...
    public static $invalidPayload = [
        ...
        "userId" =>  "524",
        "locationId" =>  999,
        "title" =>  "Umzug von Pankow nach Charlottenburg, ein Teil von Berlin in Deutschland",
