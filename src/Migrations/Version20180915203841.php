...
final class Version20180915203841 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE job_locations (id INT AUTO_INCREMENT NOT NULL, zipcode VARCHAR(5) NOT NULL, city VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_D056A5AB550C01C2 (zipcode), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
